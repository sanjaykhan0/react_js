...
export default function Footer() {
    return (
        ...
        <div class="text-center mt-5 disclam">
        <img src="https://soccerclub.axiomthemes.com/wp-content/uploads/2016/04/logofooter.png" alt="" className="fot-ball" />
        <br />
        AxiomThemes © 2024 All Rights Reserved.
        <div className="foot-icon">
            <img src="https://soccerclub.axiomthemes.com/wp-content/uploads/2016/04/logo-07.png" alt=""  className='sdow'/>
        </div>
        </div>
